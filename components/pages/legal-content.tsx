...
function LegalSectionBlock({
  ...
  return (
    <article className="rounded-[2rem] border border-white/70 bg-white/85 p-8 shadow-[0_24px_80px_rgba(24,34,52,0.12)] backdrop-blur sm:p-12">
      <p className="text-sm font-semibold uppercase tracking-[0.24em] text-stone-500">
        {t({ en: "Legal", zh: "法律" })}
      </p>
      <h1 className="mt-4 font-heading text-5xl text-stone-950">{t(title)}</h1>
